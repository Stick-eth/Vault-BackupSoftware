...
{
    /**
     *\brief This class represent the FullBackupStrategie. The FullBackupStrategie is a class that will be used to execute the full backup
     * It will be used to execute the full backup
     *
     */
    public class FullBackupStrategie : iBackupStrategie
    {
