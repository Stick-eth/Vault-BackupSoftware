...
{
    /**
     *\brief This class represent the FullBackupJobFactory. The FullBackupJobFactory is a class that will be used to instanciate the BackupJob
     * It will be used to instanciate the BackupJob when the application is restarted
     */
    internal class FullBackupJobFactory : BackupJobFactory
    {
        /**
        ...
        public override BackupJob InstanciateBackupJob(string name, string sourceDirectory, string targetDirectory)
        {
            ...
            return new BackupJob(name, sourceDirectory, targetDirectory, new FullBackupStrategie());
        }
    }
}
